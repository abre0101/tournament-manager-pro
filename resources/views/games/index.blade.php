...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @if(auth()->user()->canManageGames())
            <a href="{{ route('games.create') }}" class="btn btn-primary">+ Schedule New Game</a>
        @endif
    </div>
    ...
    @if($games->isEmpty())
        <div class="alert alert-info">No games scheduled yet. Click "Schedule New Game" to get started.</div>
    @else
